...
# Campsites
```{r}
sites = data.frame( name = c("Group Campsite","Remote Campsite","Parking"), lat = c(42.450976,42.458570,42.448013),long = c(-72.678154,-72.674732,-72.684732))
```
...
#intersect(color="blue","black","white") -- This doesn't seem to run on my computer. It gives me an error :
#Error in intersect(color = "blue", "black", "white") : 
  #unused argument (color = "blue")
```
